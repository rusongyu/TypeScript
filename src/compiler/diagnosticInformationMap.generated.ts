...
module ts {
    export var Diagnostics = {
        ...
        Option_inlineSourceMap_cannot_be_specified_without_specifying_sourceMap_option: { code: 5043, category: DiagnosticCategory.Error, key: "Option 'inlineSourceMap' cannot be specified without specifying 'sourceMap' option." },
        Option_sourceRoot_cannot_be_specified_with_option_inlineSourceMap: { code: 5044, category: DiagnosticCategory.Error, key: "Option 'sourceRoot' cannot be specified with option 'inlineSourceMap'." },
        Option_mapRoot_cannot_be_specified_with_option_inlineSourceMap: { code: 5045, category: DiagnosticCategory.Error, key: "Option 'mapRoot' cannot be specified with option 'inlineSourceMap'." },
